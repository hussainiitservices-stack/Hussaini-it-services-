...
export const metadata = createPageMetadata({
  ...
  description:
    "Terms and Conditions for using Hussaini IT Services website, contact forms, and digital service agreements.",
  path: "/terms-and-conditions",
  keywords: ["terms and conditions", "service agreement", "Hussaini IT Services terms"],
});
...
export default function TermsAndConditions() {
  ...
  return (
    <>
      <PageSeo
        schemas={[
          webPageJsonLd({ title: pageTitle, description: pageDescription, path: "/terms-and-conditions" }),
          breadcrumbJsonLd([
            { name: "Home", path: "/" },
