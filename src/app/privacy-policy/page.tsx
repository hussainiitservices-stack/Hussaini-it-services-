...
export const metadata = createPageMetadata({
  ...
  description:
    "Privacy Policy for Hussaini IT Services — how we collect, use, and protect your personal information when you use our website and contact forms.",
  path: "/privacy-policy",
  keywords: ["privacy policy", "data protection", "GDPR", "Hussaini IT Services privacy"],
});
...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <PageSeo
        schemas={[
          webPageJsonLd({ title: pageTitle, description: pageDescription, path: "/privacy-policy" }),
          breadcrumbJsonLd([
            { name: "Home", path: "/" },
