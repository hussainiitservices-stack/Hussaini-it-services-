  ...
  return (
    <section id="why-us" className="relative py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-24">
          {whyChooseUs.map((item, i) => (
            <RevealOnScroll key={item.title} delay={i * 0.1}>
              <motion.div whileHover={{ y: -4 }} className="premium-card rounded-xl p-6 h-full">
        ...
        <RevealOnScroll>
          <div className="premium-card rounded-2xl p-10 md:p-16 border border-border">
            <h3 className="font-display text-2xl font-bold text-center mb-12 md:text-3xl">
              Our Track Record
            </h3>
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {trackRecord.map((stat, i) => (
                ...
                >
                  <div className="font-display text-4xl font-bold accent-text md:text-5xl">
